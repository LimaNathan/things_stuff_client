...
class CategoriesCRUD extends CRUDService<CategoriesState, CategoriesDTO> {
  final ApiService api;

  CategoriesCRUD(this.api);
  @override
  Future<CategoriesState> createNew(CategoriesDTO dto) async {
    try {
  ...
  @override
  Future<CategoriesState> update(CategoriesDTO dto) async {
    try {
